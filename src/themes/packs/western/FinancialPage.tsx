      ...
      <div className="relative min-h-screen flex flex-col pb-24 max-w-md md:max-w-2xl lg:max-w-4xl mx-auto w-full shadow-2xl overflow-hidden border-x-8 border-[#5c4033]"
        ...
        <div className="px-4 mb-8">
          <div className="bg-[#fffdf0] rounded-sm p-5 border-2 border-[#2c1810] relative"
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-base font-bold text-[#2c1810] font-rye uppercase tracking-wider">Financial Trend</h3>
            ...
            <div className="w-full">
              <FinancialLineChart data={last7Days} formatCurrency={formatCurrency} />
            </div>
          </div>
        </div>
        ...
        {pieData.length > 0 && (
          <div className="px-4 mb-8">
            <div className="bg-[#fffdf0] rounded-sm p-5 border-2 border-[#2c1810] relative"
              style={{ boxShadow: '2px 2px 5px rgba(0,0,0,0.2), inset 0 0 30px rgba(160,140,100,0.1)' }}>
              <div className="absolute -top-2 -left-2 bg-neutral-400 w-4 h-4 rounded-full shadow border border-black z-10" />
              <div className="mb-4">
                <h3 className="text-base font-bold text-[#2c1810] font-rye uppercase tracking-wider">Spending Distribution</h3>
                <p className="text-xs text-[#2c1810]/60 mt-1">
                  Breakdown by Category
                </p>
              </div>
              <div className="w-full">
                <FinancialPieChart data={pieData} formatCurrency={formatCurrency} />
              </div>
            </div>
          </div>
        )}
